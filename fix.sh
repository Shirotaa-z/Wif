...
echo -e "${C_B_GRN}▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰${R}"
echo -e "${B}${C_B_YLW}  PROTOCOL COMPLETE. MAINTAINER:AMJ Ashraful{R}"
echo -e "${C_D_GRN}  [*] GitHub       : ${C_B_GRN}ashrafuljoy62${R}"
echo -e "${C_D_GRN}  [*] Facebook     : ${C_B_GRN}ashrafulalam05${R}"
echo -e "${C_D_GRN}  [*] Telegram     : ${C_B_GRN}@premium_master_62${R}"
echo -e "${C_D_GRN}  [*] TG Channel   : ${C_B_GRN}@movieallpremium${R}"
echo -e "${C_D_GRN}  [*] Google Search: ${C_B_GRN}ashrafuljoy${R}"
echo -e "${C_B_GRN}▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰${R}"
